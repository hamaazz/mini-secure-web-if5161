...
def dashboard():
    user = get_current_user()
    user_files = UserFile.query.filter_by(user_id=user.id).order_by(UserFile.uploaded_at.desc()).all()
...
def delete_file(file_id):
    ...
    # Authorization: hanya pemilik file yang boleh menghapus
    ...
    if os.path.exists(file_path):
        try:
            ...
            # kalau gagal remove, kita lanjut hapus metadata saja
            pass
        ...
        for fname in os.listdir(user_folder):
            ...
            if os.path.isfile(fpath):
                try:
                    ...
                    pass
        # setelah file dihapus, boleh hapus foldernya
        try:
